    ...
    <div>
      ...
      {view !== "map" && (
        <button
          type="button"
          onClick={() => setView("map")}
          className="fixed bottom-20 right-4 z-[70] flex h-11 items-center gap-2 rounded-full bg-primary px-5 text-sm font-semibold text-primary-foreground shadow-lg ring-1 ring-primary/40 sm:bottom-6 sm:right-6"
          aria-label="Open map"
        >
