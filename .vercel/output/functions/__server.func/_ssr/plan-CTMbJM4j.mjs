...
import { a as useTrip, u as Button } from "./router-B0_otA2Y.mjs";
import { t as Input } from "./input-C1XZAsxU.mjs";
import { n as getListing } from "./listings-Dhhe984p.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/plan-CTMbJM4j.js
...
function PlanPage() {
	...
	const fromTrip = items.map((i) => getListing(i.slug)?.name).filter(Boolean).slice(0, 8);
